  ...
  return (
    <div className="isolate bg-black px-6 py-24 sm:py-32 lg:px-8 relative">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        Let’s team up or talk more — contact us anytime!
        </p>
      </div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <textarea
                id="message"
                rows={4}
                className="block w-full rounded-md border-none bg-gray-50 dark:bg-zinc-800 px-3.5 py-2 text-black dark:text-white shadow-input 0 outline-none focus:ring-2 focus:ring-gradient-to-r from-[#F9D689] to-[#937E51]"
              />
            </div>
          </div>
          ...
          <div className="flex gap-x-4 sm:col-span-2">
            <button
              ...
              className={`flex w-8 h-6 items-center rounded-full p-px ring-1 ring-gray-900/5 transition-colors duration-200 ease-in-out ${
                agreeToPolicy ? "bg-gradient-to-r from-[#F9D689] to-[#937E51]" : "bg-gray-200"
              }`}
              role="switch"
