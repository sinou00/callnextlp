import {
  ...
  export default function FooterSection() {
    return (
      <footer
        role="contentinfo"
        className="bg-black flex flex-col items-center justify-center text-sm font-medium py-12 md:py-16 lg:py-24 px-8 lg:px-24 w-full w-screen-sm md:w-screen-md"
      >
